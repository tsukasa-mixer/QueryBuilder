...
class BuildUpdateTest extends BaseTest
{
    public function testSimple()
    {
        ...
        $qb->setTypeUpdate()->addWhere(['id' => 1])->update('test', ['name' => 'foo']);
    ...
    {
        $qb = $this->getQueryBuilder();
        $qb->setTypeUpdate()->addWhere(['id' => 1])->update('test', ['id' => new Expression('`id`+1')]);
    ...
    {
        $qb = $this->getQueryBuilder();
        $qb->setTypeUpdate()->addWhere(['id' => 1])->update('test', ['name' => null]);
